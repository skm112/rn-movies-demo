...
import { fetchDailyTrending } from '../asyncThunks'
...
export const dailyTrendingSlice = createSlice({
    name: 'dailyTrending',
    initialState,
    reducers: {
        resetDailyTrending: (state) => {
            state = initialState
        }
    },
    extraReducers: (builder) => {
        builder
            .addCase(fetchDailyTrending.pending, (state, action) => {
...
export const { resetDailyTrending } = dailyTrendingSlice.actions

export default dailyTrendingSlice.reducer
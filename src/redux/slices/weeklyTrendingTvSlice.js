...
import { fetchWeeklyTrendingTv } from '../asyncThunks'
...
export const weeklyTrendingTvSlice = createSlice({
    name: 'weeklyTrendingTv',
    initialState,
    reducers: {
        resetWeeklyTrendingTv: (state) => {
            state = initialState
        }
    },
    extraReducers: (builder) => {
        builder
            .addCase(fetchWeeklyTrendingTv.pending, (state, action) => {
            ...
            .addCase(fetchWeeklyTrendingTv.fulfilled, (state, action) => {
            ...
            .addCase(fetchWeeklyTrendingTv.rejected, (state, action) => {
                const { indicatorType } = action.meta.arg
                if (indicatorType == "refresh") {
                    state.isRefreshing = false
                } else if (indicatorType == "next-page") {
...
export const { resetWeeklyTrendingTv } = weeklyTrendingTvSlice.actions

export default weeklyTrendingTvSlice.reducer